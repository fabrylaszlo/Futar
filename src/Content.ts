...
export default class Content {
    public content(req: http.IncomingMessage, res: http.ServerResponse): void {
        ...
        res.write(`<p>2.feladat: 1.nap 1.fuvar: ${megold.hetielso}km</p>`);
        res.write(`<p>3.feladat: A hét utolsó fuvara: ${megold.hetiutolso.szamol}km</p>`);
        res.write(`<p>4.feladat: ${megold.szabadnap}-i napon nem dolgozott</p>`);
        res.write(`<p>5.feladat: A legtöbb fuvar ${megold.Legtöbbfuvar}-i napon történt</p>`);
        res.write(`6.feladat:\n`);
